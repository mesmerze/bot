  ...
  context "scopes" do
    describe "have_assigned_opportunities" do
      before do
        ...
        @user1 = create(:user)
        create(:opportunity, assignee: @user1, stage: 'analysis', account: @account, campaign: nil, user: nil)

        @user2 = create(:user)

        @user3 = create(:user)
        create(:opportunity, assignee: @user3, stage: 'won', account: @account, campaign: nil, user: nil)

        @user4 = create(:user)
        create(:opportunity, assignee: @user4, stage: 'lost', account: @account, campaign: nil, user: nil)
  ...
  context "instance methods" do
    describe "assigned_opportunities" do
      before do
        ...
        @opportunity1 = create(:opportunity, assignee: @user, account: @account, campaign: nil, user: nil)
        @opportunity2 = create(:opportunity, assignee: create(:user), account: @account, campaign: nil, user: nil)
