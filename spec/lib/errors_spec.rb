...
describe 'ActiveModel Validation Errors' do
  it 'should render explicit error message if it starts with a caret' do
    ...
    adam = Adam.create(username: 'adam', email: 'adam@tablesolution.com', password: 'ouchmyrib')
  ...
  it 'should exhibit default behavior' do
    ...
    eve = Eve.create(username: 'eve', email: 'eve@tablesolution.com', password: 'doyoulikeapples')
